              ...
              {state?.map((value, index) => {
                return (
                  ...
                  >
                    ...
                    <Link href={`/Recipe/${encodeURIComponent(value.id)}`}>
                      <a className="w-max px-6 py-2 border-2 border-themeColor dark:border-yellow-200 dark:text-yellow-200 duration-300 ease-in-out hover:scale-110 text-themeColor">
                        View Recipe
                      </a>
                    </Link>
                  </div>
